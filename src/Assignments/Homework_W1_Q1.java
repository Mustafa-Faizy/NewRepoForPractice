...
public class Homework_W1_Q1 {
	...
	// Homework_W1_Q1
		...
		String firstName = "Bradley";
		String lastName = "Cooper";
		int numberOfFilms = 32;
System.out.println(firstName + " " + lastName + " " + numberOfFilms);
		// Your code goes here

		// Print the $message1 and $message2 and run the code

		String sentence1 = "The Brown rabbit jumped";
		String sentence2 = " over the basket and broke the vases";
		int points = 60;
		...
		String message2 = firstName + " " + lastName + " " + "was an actor who starred in" + " " + numberOfFilms;
